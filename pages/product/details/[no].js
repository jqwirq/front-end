...
function isArraysHaveNotChange(a, b) {
  if (a.length !== b.length) {
    return false; // Array lengths are different, indicating a change
  }
  ...
  for (let value of setA) {
    if (!setB.has(value)) {
      return false; // Element in setA is not found in setB, indicating a change
    }
  }

  return true; // No elements have been removed or changed
}
