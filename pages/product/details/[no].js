  ...
  return (
    <>
      <div className='min-h-screen max-h-screen flex flex-col'>
        <div className='bg-slate-900 text-slate-200 shrink-0 basis-12 px-6 flex justify-between items-center'>
          <Link
        ...
        <div className='grow overflow-hidden flex flex-col gap-8 py-10 px-10 md:px-[8%] lg:px-[10%]'>
          {!data && (
