...
export default function Page() {
  ...
  return (
    <WeighingProcessContext.Provider value={value}>
      ...
      {isAlert && (
        <div className='bg-slate-900/50 fixed inset-0 flex justify-center items-center z-20'>
          <div
  ...
  return (
    <>
      <button
        ...
        // }`}
        className={`basis-1/2 py-4 text-sm bg-slate-300 hover:brightness-105 active:brightness-90`}
        onClick={() => {
          setisOpen(true);
        }}
